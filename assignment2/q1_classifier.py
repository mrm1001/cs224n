...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        """
        x = tf.placeholder(tf.float32, shape=(self.config.batch_size, self.config.n_features), name='x')
        y = tf.placeholder(tf.int32, shape=(self.config.batch_size, self.config.n_classes), name='y')
